/* Name: Phạm Đăng Quang - ITCSIU21147
 Purpose: The main class that responsibility for all events in game
*/
package app;
...
public class Window extends Application {
	...
	public void start(Stage primaryStage) throws Exception {	
		...
		window.setTitle("Speed Typing game");
	...
	public static void startGame(List<File> selected) {
		...
		Word first = new Word(0, 195, "Start");		// first word
		words.add(first);
		...
		Scenes.input.setOnKeyPressed(e -> {
			...
			case ENTER:
				...
				if(Scenes.input.getText().equals("endit")) {	// special word to end the game
					curtain(scene, root);
				}
